...
<div class="child" style="text-align:center">
  <div class="container d-flex flex-column justify-content-center align-items-center mt-auto mb-auto">
    ...
    <p><input type="email" name="beforeMail" value="" class="form-control mb-2" placeholder="既存メールアドレス"></p>
    <p class="mb-2">・新しいメールアドレス</p>
    <p><input type="email" name="afterMail" value="" class="form-control mb-2" placeholder="新規メールアドレス"></p>
